...
public class act_uploadsembako extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_uploadsembako);
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Sembako");
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(act_uploadsembako.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
            ...
            {
                Toast.makeText(act_uploadsembako.this, "sukses unggah barang", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(act_uploadsembako.this, "berhasil ", Toast.LENGTH_SHORT).show();
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(act_uploadsembako.this, kategori.class);
                            startActivity(intent);

                            loadingBar.dismiss();
                            Toast.makeText(act_uploadsembako.this, "sukses ", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
