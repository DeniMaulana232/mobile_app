...
public class act_uploadkerajinan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Kerajinan");
    ...
    private void StoreProductInformation()
    {
        ...
        productRandomKey = saveCurrentDate + saveCurrentTime + "PikaboyTeam" + nama2;
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(act_uploadkerajinan.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
            ...
            {
                Toast.makeText(act_uploadkerajinan.this, "sukses unggah barang", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(act_uploadkerajinan.this, "berhasil ", Toast.LENGTH_SHORT).show();
        ...
        ProductsRef.child(productRandomKey).updateChildren(productMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            Intent intent = new Intent(act_uploadkerajinan.this, kategori.class);
                            startActivity(intent);

                            loadingBar.dismiss();
                            Toast.makeText(act_uploadkerajinan.this, "sukses ", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
