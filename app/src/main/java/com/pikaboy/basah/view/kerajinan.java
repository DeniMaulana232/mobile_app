...
public class kerajinan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databasereference = FirebaseDatabase.getInstance().getReference("Kerajinan");
        ...
        adapter = new FirebaseRecyclerAdapter<datasetfire, FirebaseViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull FirebaseViewHolder holder, int position, @NonNull final datasetfire model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent Intent = new Intent(kerajinan.this, detailbarang.class);
            ...
            public FirebaseViewHolder onCreateViewHolder(@NonNull ViewGroup ViewGroup, int  i) {
                return new FirebaseViewHolder(LayoutInflater.from(kerajinan.this).inflate(R.layout.row1,ViewGroup,false));
            }
        };
